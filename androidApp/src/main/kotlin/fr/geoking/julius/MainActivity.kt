...
fun MainUIPreview() {
    ...
    val previewJulesRepository = remember {
            ...
            JulesRepository(
                ...
                object : JulesDao {
                    ...
                    override suspend fun updateSessionPrStatus(sessionId: String, state: String, mergeable: Boolean?, mergeableState: String?) {}
    ...
    val previewFeatureDao = remember {
        object : fr.geoking.julius.persistence.FeatureDao {
            ...
            override suspend fun getFeatureBySessionId(sessionId: String): fr.geoking.julius.persistence.FeatureEntity? = null
            ...
            override suspend fun markFeatureQueued(id: String, now: Long) {}
