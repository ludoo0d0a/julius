...
private fun calculateProgressStep(session: JulesSessionEntity, chatItems: List<JulesChatItem>): ProgressStep? {
    ...
    val hasSubmit = agentMessages.any { it.text.contains("Submit the changes", ignoreCase = true) || it.text.contains("submitting changes", ignoreCase = true) }
