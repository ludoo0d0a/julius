...
val mapModule = module {
    ...
    single<PoiProvider>(named("selector")) {
        SelectorPoiProvider(
            ...
            sloveniaGoriva = get(named("sloveniagoriva")),
            ...
            drivstoffAppen = get(named("drivstoffappen")),
            denmarkFuelprices = get(named("denmarkfuelprices")),
            ...
            australiaFuelCheck = get(named("australiafuelcheck")),
